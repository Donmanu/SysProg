...
\end{tikzpicture}
\caption{Die Zuständes des Automaten, welche die Token(gruppe) \texttt{SingleSign}, \texttt{Identifier} und \texttt{Number} erzeugen, sowie Kommentare übergehen. $default$ steht hier für den Rest von $\sum$, der keinen anderen Übergang von diesem Knoten erzeugt.} \label{fig:autom}
\end{center}
\end{figure}
...
% TODO listing gets split by fig:autom2
