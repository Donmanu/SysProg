...
\draw [black] (30.8,-31.1) circle (3.5);
\draw (30.8,-31.1) node {$Restart$};

\draw [black] (53.2,-7.4) circle (3.5);
\draw (53.2,-7.4) node {$And$};

\draw [black] (22.3,-52.5) circle (3.5);
\draw (22.3,-52.5) node {$Equ$};
\draw [black] (22.3,-52.5) circle (2.8);

\draw [black] (10.2,-12.8) circle (3.5);
\draw (10.2,-12.8) node {$EquCol$};

% Lines
\draw [black] (33.8,-30.97) -- (54.7,-30.03);
\fill [black] (54.7,-30.03) -- (53.88,-29.57) -- (53.93,-30.57);
\draw (44.29,-31.04) node [below] {$\epsilon$};			% Restart > Start

\draw [black] (57.11,-26.96) -- (53.79,-10.34);
\fill [black] (53.79,-10.34) -- (53.45,-11.22) -- (54.44,-11.03);
\draw (57.4,-18.34) node [right] {$[\&]$};			% Start > And

\draw [black] (53.79,-10.34) -- (57.11,-26.96); % TODO make arc
\fill [black] (57.11,-26.96) -- (57.45,-26.08) -- (56.46,-26.27);
\draw (53.5,-18.96) node [left] {$[\&]$};				% And > Start

\draw [black] (51.14,-9.58) -- (32.86,-28.92); % TODO make arc
\fill [black] (32.86,-28.92) -- (33.77,-28.68) -- (33.05,-27.99);
\draw (43.47,-16.4) node [left] {$default$};			% And > Restart

\draw [black] (55.17,-31.51) -- (24.83,-50.89);
\fill [black] (24.83,-50.89) -- (25.77,-50.88) -- (25.23,-50.03);
\draw (37.85,-40.7) node [above] {$[=]$};				% Start > Equal

\draw [black] (21.43,-49.63) -- (11.07,-15.67);
\fill [black] (11.07,-15.67) -- (10.83,-16.58) -- (11.79,-16.29);
\draw (17.02,-32.03) node [right] {$[:]$};				% Equ > EquCol

\draw [black] (13.02,-13.82) -- (54.88,-28.88);
\fill [black] (54.88,-28.88) -- (54.29,-28.14) -- (53.96,-29.08);
\draw (30.3,-21.0) node [below] {$[=]$};				% EquCol > Start

\draw [black] (12.44,-14.79) -- (28.56,-29.11);
\fill [black] (28.56,-29.11) -- (28.29,-28.2) -- (27.63,-28.95);
\draw (18.5,-23.44) node [below] {$default$};			% EquCol > Restart  TODO : unget(__2__)

\draw [black] (23.41,-49.71) -- (29.69,-33.89);
\fill [black] (29.69,-33.89) -- (28.93,-34.45) -- (29.86,-34.82);
\draw (27.3,-42.68) node [right] {$default$};			% Equ > Restart
\end{tikzpicture}
\end{center}
